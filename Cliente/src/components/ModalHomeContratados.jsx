...
export const ModalHomeContratados = ({contratados, setContratados}) => {
...
console.log('asdad: ', data)
    ...
    const handleLast10 = async() => {
        ...
        try {
            const response = await axios.get(`http://localhost:8081/home/last10Contratados`,
    ...
    <div className='overlay'>
        <div className='modal-postulaciones-container'>
             ...
             <div className='close-btn'>
                <button onClick={()=> setContratados(false)}>x</button>
            </div>
            {
            data? data.map((dato) => (
